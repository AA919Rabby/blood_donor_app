        ...
        actions: [
          Padding(
            ...
            child: Obx(() => authController.isLoading.value
                ...
                : InkWell(
              onTap: () {
                if (authController.imageKey.currentState!.validate()) {
                  if(selectionController.selectedBloodGroup.value.isNotEmpty){
                    authController.imageScreen();
                ...
                children: [
                  ...
                  InkWell(
                    ...
                    child: Obx(() => Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        image: authController.selectedImage.value.isNotEmpty
                            ? DecorationImage(
                            image: FileImage(File(authController.selectedImage.value)),
                            fit: BoxFit.cover)
                            : null,
                      ...
                      child: authController.selectedImage.value.isEmpty
                        ...
                        children: [
                          const Icon(Icons.add_to_photos_rounded, color: Colors.white, size: 60),
                          Text('Add image', style: GoogleFonts.numans(color: Colors.white)),
                        ],
                      ))
                          : null,
                    )),
                  ...
                  Row(
                    ...
                    children: [
                      Expanded(
                        child: CustomAuth(
                          controller: authController.weight,
                          validator: (value){
                            if(value!.isEmpty){
                  ...
                  Align(
                    ...
                    child: Text('Pick your blood ',style: GoogleFonts.numans(
                      color: Colors.grey,
                      fontSize: 16,
                     ...
                     physics: const NeverScrollableScrollPhysics(),
                      ...
                      itemBuilder: (context,index){
                        return Obx((){
                          ...
                          selectedBloodGroup.value==selectionController.bloodGroup[index];
                          return InkWell(
                            onTap: (){
                              selectionController.selectedGroup(selectionController.bloodGroup[index]);
                            },
                            child: AnimatedContainer(
                              ...
                              decoration: BoxDecoration(
                                ...
                                border: Border.all(color: isSelected?Colors.black:Colors.white,width: 1),
